...
(function (window, initComponents, undefined) {
    ...
    * ~~~
    */
    Crafty = function (selector) {
        return new Crafty.fn.init(selector);
    };

    var FPS, GUID, components, entities, entityFactories, frame
      , handlers, loops, milliSecPerFrame, nextGameTick, noSetter
      , onloads, requestID, rlist, rspace, slice, tick,
